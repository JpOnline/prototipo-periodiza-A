...
if((c === "\n")){
var G__15775 = escape_QMARK_;
var G__15776 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__15775;
lines = G__15776;
continue;
} else {
buf.append(c);

var G__15777 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__15778 = lines;
escape_QMARK_ = G__15777;
lines = G__15778;
continue;
