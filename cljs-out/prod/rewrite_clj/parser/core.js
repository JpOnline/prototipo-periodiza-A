...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__15781_SHARP_){
var _STAR_delimiter_STAR__orig_val__15782 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__15783 = delimiter;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__15783;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__15781_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__15782;
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__4736__auto__ = [];
var len__4730__auto___15792 = arguments.length;
var i__4731__auto___15793 = (0);
while(true){
if((i__4731__auto___15793 < len__4730__auto___15792)){
args__4736__auto__.push((arguments[i__4731__auto___15793]));

var G__15794 = (i__4731__auto___15793 + (1));
i__4731__auto___15793 = G__15794;
continue;
} else {
}
break;
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__15788){
var vec__15789 = p__15788;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__15789,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq15784){
var G__15785 = cljs.core.first.call(null,seq15784);
var seq15784__$1 = cljs.core.next.call(null,seq15784);
var G__15786 = cljs.core.first.call(null,seq15784__$1);
var seq15784__$2 = cljs.core.next.call(null,seq15784__$1);
var G__15787 = cljs.core.first.call(null,seq15784__$2);
var seq15784__$3 = cljs.core.next.call(null,seq15784__$2);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15785,G__15786,G__15787,seq15784__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__15795 = rewrite_clj.reader.peek.call(null,reader);
switch (G__15795) {
case "(":
...
var G__15797 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
if(cljs.core._EQ_.call(null,null,G__15797)){
return rewrite_clj.reader.throw_reader.call(null,reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.call(null,"\"",G__15797)){
...
if(cljs.core._EQ_.call(null,"_",G__15797)){
