...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__19190_SHARP_){
if(cljs.core.not_EQ_.call(null,p1__19190_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__19190_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__19191){
var vec__19192 = p__19191;
var low = cljs.core.nth.call(null,vec__19192,(0),null);
var high = cljs.core.nth.call(null,vec__19192,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__19195,s,color,element,idx){
...
var style_map = cljs.core.get.call(null,map__19196__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.call(null,map__19196__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.call(null,map__19196__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__19198){
var vec__19199 = p__19198;
var s = cljs.core.nth.call(null,vec__19199,(0),null);
var style = cljs.core.nth.call(null,vec__19199,(1),null);
var start = cljs.core.nth.call(null,vec__19199,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__19202){
var vec__19203 = p__19202;
var s = cljs.core.nth.call(null,vec__19203,(0),null);
var keyword_color = cljs.core.nth.call(null,vec__19203,(1),null);
var element = cljs.core.nth.call(null,vec__19203,(2),null);
...
var G__19206 = cljs.core.next.call(null,ssv);
var G__19207 = (this_ssv == null);
var G__19208 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__19209 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.call(null,cljs.core.conj.call(null,cljs.core.conj.call(null,out,zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.call(null,out,this_ssv)
)));
ssv = G__19206;
doing_nil_QMARK_ = G__19207;
last_elide = G__19208;
out = G__19209;
continue;
}
...
var vec__19213 = cljs.core.first.call(null,remaining_cvec);
var _ = cljs.core.nth.call(null,vec__19213,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__19213,(1),null);
var element_type = cljs.core.nth.call(null,vec__19213,(2),null);
...
var G__19216 = cljs.core.next.call(null,remaining_cvec);
var G__19217 = new_idx;
var G__19218 = cljs.core.conj.call(null,out,new_idx);
remaining_cvec = G__19216;
idx = G__19217;
out = G__19218;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__19229,cursor_vec){
var vec__19230 = p__19229;
var focus_start = cljs.core.nth.call(null,vec__19230,(0),null);
var focus_end = cljs.core.nth.call(null,vec__19230,(1),null);
var focus_vec = vec__19230;
...
var vec__19233 = cljs.core.split_at.call(null,focus_start,gcw_vec);
var front = cljs.core.nth.call(null,vec__19233,(0),null);
var back = cljs.core.nth.call(null,vec__19233,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__19236){
var vec__19237 = p__19236;
var s = cljs.core.nth.call(null,vec__19237,(0),null);
var color = cljs.core.nth.call(null,vec__19237,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__19243,existing_count){
var vec__19244 = p__19243;
var s = cljs.core.nth.call(null,vec__19244,(0),null);
var cursor = cljs.core.nth.call(null,vec__19244,(1),null);
...
return cljs.core.filterv.call(null,((function (s__$1,len,cursor__$1,vec__19244,s,cursor){
return (function (p1__19240_SHARP_){
return (!(cljs.core.empty_QMARK_.call(null,cljs.core.first.call(null,p1__19240_SHARP_))));
});})(s__$1,len,cursor__$1,vec__19244,s,cursor))
...
var vec__19251 = cljs.core.first.call(null,cvec_nl);
var n = cljs.core.nth.call(null,vec__19251,(0),null);
var where = cljs.core.nth.call(null,vec__19251,(1),null);
var cvec_element = vec__19251;
if((cvec_element == null)){
var G__19254 = cljs.core.next.call(null,cvec_nl);
var G__19255 = (idx + (1));
var G__19256 = start;
var G__19257 = out;
cvec_nl = G__19254;
...
var G__19258 = cljs.core.next.call(null,cvec_nl);
var G__19259 = (idx + (1));
var G__19260 = idx;
var G__19261 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__19258;
idx = G__19259;
start = G__19260;
out = G__19261;
...
var G__19262 = cljs.core.next.call(null,cvec_nl);
var G__19263 = (idx + (1));
var G__19264 = (idx + (1));
var G__19265 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__19262;
idx = G__19263;
start = G__19264;
out = G__19265;
...
var G__19266 = cljs.core.next.call(null,cvec_nl);
var G__19267 = (idx + (1));
var G__19268 = idx;
var G__19269 = cljs.core.apply.call(null,cljs.core.conj,cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__19266;
idx = G__19267;
start = G__19268;
out = G__19269;
...
var G__19270 = cljs.core.next.call(null,cvec_nl);
var G__19271 = (idx + (1));
var G__19272 = start;
var G__19273 = cljs.core.apply.call(null,cljs.core.conj,out,cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__19270;
idx = G__19271;
start = G__19272;
out = G__19273;
...
if(zprint.finish.within_QMARK_.call(null,idx,p2__19274_SHARP_)){
return cljs.core.reduced.call(null,p1__19275_SHARP_);
} else {
return (p1__19275_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__19276,p__19277){
var vec__19278 = p__19276;
var focus_begin = cljs.core.nth.call(null,vec__19278,(0),null);
var focus_end = cljs.core.nth.call(null,vec__19278,(1),null);
var vec__19281 = p__19277;
var before = cljs.core.nth.call(null,vec__19281,(0),null);
var after = cljs.core.nth.call(null,vec__19281,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__19285,cvec,focus_vec){
...
var map__19287 = cljs.core.get.call(null,map__19286__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__19287__$1 = (((((!((map__19287 == null))))?(((((map__19287.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19287.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19287):map__19287);
var focus = cljs.core.get.call(null,map__19287__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.call(null,map__19287__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.call(null,map__19287__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.call(null,((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__19286,map__19286__$1,options,map__19287,map__19287__$1,focus,lines,paths){
return (function (p1__19284_SHARP_){
return zprint.finish.surround_focus.call(null,lines_to_cvec,p1__19284_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__19286,map__19286__$1,options,map__19287,map__19287__$1,focus,lines,paths))
,path_vecs);
