...
var vec__20161 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper.call(null,options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__20164 = zprint.zutil.find_root_and_path_nw.call(null,coll);
var root = cljs.core.nth.call(null,vec__20164,(0),null);
var path = cljs.core.nth.call(null,vec__20164,(1),null);
...
var input = cljs.core.nth.call(null,vec__20161,(0),null);
var options__$1 = cljs.core.nth.call(null,vec__20161,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__20167){
var vec__20168 = p__20167;
var width_or_options = cljs.core.nth.call(null,vec__20168,(0),null);
var options = cljs.core.nth.call(null,vec__20168,(1),null);
...
var vec__20174 = zprint.config.perform_remove.call(null,null,null,zprint.config.get_options.call(null),rest_options);
var internal_map = cljs.core.nth.call(null,vec__20174,(0),null);
var rest_options__$1 = cljs.core.nth.call(null,vec__20174,(1),null);
var _ = cljs.core.nth.call(null,vec__20174,(2),null);
var vec__20177 = zprint.config.apply_style.call(null,null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.call(null,vec__20177,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__20177,(1),null);
var style_errors = cljs.core.nth.call(null,vec__20177,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__20182){
var vec__20183 = p__20182;
var start = cljs.core.nth.call(null,vec__20183,(0),null);
var end = cljs.core.nth.call(null,vec__20183,(1),null);
...
var vec__20189 = zprint.core.process_rest_options.call(null,internal_options,rest);
var special_option = cljs.core.nth.call(null,vec__20189,(0),null);
var rest_options = cljs.core.nth.call(null,vec__20189,(1),null);
...
var vec__20192 = zprint.core.zprint_STAR_.call(null,coll,special_option,actual_options);
var cvec = cljs.core.nth.call(null,vec__20192,(0),null);
var options = cljs.core.nth.call(null,vec__20192,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq20186){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20187,G__20188,seq20186__$2);
});
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq20200){
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq20205){
var G__20206 = cljs.core.first.call(null,seq20205);
var seq20205__$1 = cljs.core.next.call(null,seq20205);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20206,seq20205__$1);
});
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq20210){
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq20215){
var G__20216 = cljs.core.first.call(null,seq20215);
var seq20215__$1 = cljs.core.next.call(null,seq20215);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20216,seq20215__$1);
});
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__20221,form){
var vec__20222 = p__20221;
var next_options = cljs.core.nth.call(null,vec__20222,(0),null);
var _ = cljs.core.nth.call(null,vec__20222,(1),null);
var indent = cljs.core.nth.call(null,vec__20222,(2),null);
var zprint_num = cljs.core.nth.call(null,vec__20222,(3),null);
...
var vec__20225 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.call(null,vec__20225,(0),null);
var error_str = cljs.core.nth.call(null,vec__20225,(1),null);
