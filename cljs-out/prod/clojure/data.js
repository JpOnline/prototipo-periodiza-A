...
return cljs.core.reduce.call(null,(function (result,p__14709){
...
var vec__14713 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__14713,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__14713,(1),null);
var ab = cljs.core.nth.call(null,vec__14713,(2),null);
...
return (function (){var G__14722 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14722__$1)].join('')));
