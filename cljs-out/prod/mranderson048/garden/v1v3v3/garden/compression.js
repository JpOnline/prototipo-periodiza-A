 ...
 */
mranderson048.garden.v1v3v3.garden.compression.token_fn = (function mranderson048$garden$v1v3v3$garden$compression$token_fn(p__21372){
var vec__21373 = p__21372;
var tag = cljs.core.nth.call(null,vec__21373,(0),null);
var re = cljs.core.nth.call(null,vec__21373,(1),null);
return ((function (vec__21373,tag,re){
return (function (s){
...
var len__4730__auto___21378 = arguments.length;
var i__4731__auto___21379 = (0);
while(true){
if((i__4731__auto___21379 < len__4730__auto___21378)){
args__4736__auto__.push((arguments[i__4731__auto___21379]));

var G__21380 = (i__4731__auto___21379 + (1));
i__4731__auto___21379 = G__21380;
continue;
} else {
}
break;
...
return p1__21376_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
/** @this {Function} */
mranderson048.garden.v1v3v3.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq21377){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21377));
});
...
var map__21381 = temp__5733__auto__;
var map__21381__$1 = (((((!((map__21381 == null))))?(((((map__21381.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21381.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21381):map__21381);
var tag = cljs.core.get.call(null,map__21381__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__21381__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__21381__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__21385 = cljs.core.subs.call(null,s1,size);
var G__21386 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__21384 = tag;
