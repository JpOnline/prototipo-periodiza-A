...
var vec__16360_16363 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_16364 = cljs.core.nth.call(null,vec__16360_16363,(0),null);
var only_after_16365 = cljs.core.nth.call(null,vec__16360_16363,(1),null);
var db_changed_QMARK__16366 = (((!((only_before_16364 == null)))) || ((!((only_after_16365 == null)))));
if(db_changed_QMARK__16366){
...
mranderson048.re_frame.v0v10v2.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_16364);

mranderson048.re_frame.v0v10v2.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_16365);
...
var map__16367 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__16367__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__16367__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__16369 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__16369__$1;
var event = cljs.core.get.call(null,map__16369__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
/** @this {Function} */
mranderson048.re_frame.v0v10v2.re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq16371){
...
return cljs.core.get_in.call(null,new_db,p1__16375_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__16376_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__16376_SHARP_);
...
/** @this {Function} */
mranderson048.re_frame.v0v10v2.re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq16377){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16378,G__16379,seq16377__$2);
});
