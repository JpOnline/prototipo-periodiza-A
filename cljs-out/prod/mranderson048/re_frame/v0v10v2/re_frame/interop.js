...
return [(function (){var pred__16306 = cljs.core.instance_QMARK_;
var expr__16307 = reactive_val;
if(cljs.core.truth_(pred__16306.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.RAtom,expr__16307))){
return "ra";
} else {
if(cljs.core.truth_(pred__16306.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.RCursor,expr__16307))){
return "rc";
} else {
if(cljs.core.truth_(pred__16306.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.Reaction,expr__16307))){
return "rx";
} else {
if(cljs.core.truth_(pred__16306.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.Track,expr__16307))){
return "tr";
} else {
return "other";
}
