...
var G__13378 = devtools.prefs.pref.call(null,v);
v = G__13378;
continue;
} else {
return v;
...
}catch (e13381){var _e__12392__auto__ = e13381;
return false;
}})();
...
}catch (e13385){var _e__12392__auto__ = e13385;
return false;
}})();
...
}catch (e13387){var _e__12392__auto__ = e13387;
return false;
}}
}
});
...
var vec__13389 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13389,(0),null);
var name = cljs.core.nth.call(null,vec__13389,(1),null);
...
return cljs.core.some.call(null,(function (p1__13392_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13392_SHARP_);
}),template);
});
