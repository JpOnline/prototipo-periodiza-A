...
var o13273 = temp__5733__auto__;
var temp__5733__auto____$1 = (o13273["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o13274 = temp__5733__auto____$1;
return (o13274["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12385__auto__ = f;
return (o__12385__auto__["toString"]).call(o__12385__auto__);
} else {
return "";
}
}catch (e13275){var _ = e13275;
return "";
}});
...
try{var o__12385__auto___13277 = t;
(o__12385__auto___13277["cljs$lang$ctorPrWriter"]).call(o__12385__auto___13277,t,writer);
}catch (e13276){var __13278 = e13276;
}
...
var char_code = (function (){var o__12385__auto__ = (new String(char$));
return (o__12385__auto__["charCodeAt"]).call(o__12385__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12385__auto__ = String;
return (o__12385__auto__["fromCharCode"]).call(o__12385__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13279 = num_code;
switch (G__13279) {
case (1):
return (185);
...
var o__12385__auto__ = String;
return (o__12385__auto__["fromCharCode"]).call(o__12385__auto__,superscript_code);
});
/**
...
}catch (e13281){var _e__12392__auto__ = e13281;
return false;
}})())){
...
var vec__13282 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__13282,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o13285 = temp__5733__auto__;
var temp__5733__auto____$1 = (o13285["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o13286 = temp__5733__auto____$1;
return (o13286["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13289){
var vec__13290 = p__13289;
var ns_detector = cljs.core.nth.call(null,vec__13290,(0),null);
...
var G__13296 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__13297 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__13296;
remaining_tokens = G__13297;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13287){
var G__13288 = cljs.core.first.call(null,seq13287);
var seq13287__$1 = cljs.core.next.call(null,seq13287);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13288,seq13287__$1);
});
...
var vec__13301 = cljs.core.split_with.call(null,(function (p1__13300_SHARP_){
return cljs.core.not_EQ_.call(null,p1__13300_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__13301,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__13301,(1),null);
...
var vec__13307 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__13307,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__13307,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__13310 = cljs.core.rest.call(null,remaining_tokens);
var G__13311 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__13310;
name_tokens = G__13311;
continue;
} else {
...
var vec__13314 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__13314,(0),null);
var arity = cljs.core.nth.call(null,vec__13314,(1),null);
var vec__13317 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__13317,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__13317,(1),null);
var vec__13320 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__13320,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__13320,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__13320,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__13320,(3),null);
...
var vec__13326 = result;
var munged_ns = cljs.core.nth.call(null,vec__13326,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__13326,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__13326,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__13326,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__13326,(4),null);
var arity = cljs.core.nth.call(null,vec__13326,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__13330 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__13330,(0),null);
var args = cljs.core.nth.call(null,vec__13330,(1),null);
var vec__13333 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__13333,(0),null);
var name = cljs.core.nth.call(null,vec__13333,(1),null);
...
var G__13336 = (arity + (1));
var G__13337 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13338){
var vec__13339 = p__13338;
var arity = cljs.core.nth.call(null,vec__13339,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13339,(1),null);
...
return cljs.core.get.call(null,arities,p1__13342_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__13343_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13346){
var vec__13347 = p__13346;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13347,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13344){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__13355__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13355__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13355__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13355__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13356 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13356,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13356,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13356,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13356,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13356,(4),null);
var arity = cljs.core.nth.call(null,vec__13356,(5),null);
...
var o__12385__auto__ = f;
return (o__12385__auto__["getBasis"]).call(o__12385__auto__);
});
/**
...
}catch (e13360){var _e__12392__auto__ = e13360;
...
var G__13361 = (obj[cljs.core.first.call(null,path)]);
var G__13362 = cljs.core.rest.call(null,path);
obj = G__13361;
path = G__13362;
continue;
} else {
...
return (function (accum,p__13363){
var vec__13364 = p__13363;
var bit = cljs.core.nth.call(null,vec__13364,(0),null);
var protocol = cljs.core.nth.call(null,vec__13364,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13367){
var vec__13368 = p__13367;
var ns = cljs.core.nth.call(null,vec__13368,(0),null);
var name = cljs.core.nth.call(null,vec__13368,(1),null);
var selector = cljs.core.nth.call(null,vec__13368,(2),null);
...
return (function (p__13372){
var vec__13373 = p__13372;
var munged_name = cljs.core.nth.call(null,vec__13373,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13373,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__13373,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__13371_SHARP_){
return (obj[cljs.core.first.call(null,p1__13371_SHARP_)]);
});})(name,sorted_matches,vec__13373,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
