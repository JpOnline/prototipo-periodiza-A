...
return cljs.core.filter.call(null,(function (p1__20261_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__20261_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__20261_SHARP_) <= ending)));
}));
});
...
var G__20262 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
return cljs.core._EQ_.call(null,new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__20264_SHARP_);
});})(and__4120__auto__))
...
return cljs.core.assoc_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some.call(null,(function (p1__20265_SHARP_){
return cljs.core._EQ_.call(null,app_db_id,p1__20265_SHARP_);
...
})),cljs.core.map.call(null,(function (p__20266){
...
var new_state = (function (){var G__20270 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
case "sub/run":
return cljs.core.update.call(null,state,reaction_id,((function (G__20270,G__20270__$1,tags,reaction_id,state){
...
});})(G__20270,G__20270__$1,tags,reaction_id,state))
);
...
return (function (all_state,p__20271){
var vec__20272 = p__20271;
var sub_id = cljs.core.nth.call(null,vec__20272,(0),null);
var sub_state = cljs.core.nth.call(null,vec__20272,(1),null);
