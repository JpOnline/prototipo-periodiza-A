...
mranderson048.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("settings","panel-width%-rounded","settings/panel-width%-rounded",1475049191),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","panel-width%","settings/panel-width%",-1897072808)], null),(function (panel_width_PERCENT_,p__20278){
var vec__20279 = p__20278;
var _ = cljs.core.nth.call(null,vec__20279,(0),null);
var n = cljs.core.nth.call(null,vec__20279,(1),null);
...
mranderson048.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("settings","window-width-rounded","settings/window-width-rounded",-924202629),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","window-width","settings/window-width",640332180)], null),(function (width,p__20282){
var vec__20283 = p__20282;
var _ = cljs.core.nth.call(null,vec__20283,(0),null);
var n = cljs.core.nth.call(null,vec__20283,(1),null);
...
return cljs.core.map.call(null,(function (p1__20286_SHARP_){
return cljs.core.assoc.call(null,cljs.core.val.call(null,p1__20286_SHARP_),new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.key.call(null,p1__20286_SHARP_));
...
mranderson048.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("traces","current-event-traces","traces/current-event-traces",1386605769),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","all-traces","traces/all-traces",-755374523)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","beginning-trace-id","epochs/beginning-trace-id",-1340593887)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","ending-trace-id","epochs/ending-trace-id",-1920901579)], null),(function (p__20291,_){
var vec__20292 = p__20291;
var traces = cljs.core.nth.call(null,vec__20292,(0),null);
var beginning = cljs.core.nth.call(null,vec__20292,(1),null);
var ending = cljs.core.nth.call(null,vec__20292,(2),null);
...
day8.re_frame_10x.subs.filter_ignored_views = (function day8$re_frame_10x$subs$filter_ignored_views(p__20295,_){
var vec__20296 = p__20295;
var traces = cljs.core.nth.call(null,vec__20296,(0),null);
var filtered_views = cljs.core.nth.call(null,vec__20296,(1),null);
...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.remove.call(null,((function (munged_ns,vec__20296,traces,filtered_views){
...
});})(munged_ns,vec__20296,traces,filtered_views))
),traces);
});
...
mranderson048.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","current-match-state","epochs/current-match-state",-1577612281),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","epoch-root","epochs/epoch-root",-2097634597)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__20299,_){
var vec__20300 = p__20299;
var epochs = cljs.core.nth.call(null,vec__20300,(0),null);
var match_ids = cljs.core.nth.call(null,vec__20300,(1),null);
...
mranderson048.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","older-epochs-available?","epochs/older-epochs-available?",366051335),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__20303){
var vec__20304 = p__20303;
var current = cljs.core.nth.call(null,vec__20304,(0),null);
var ids = cljs.core.nth.call(null,vec__20304,(1),null);
return ((((1) < cljs.core.count.call(null,ids))) && ((((current == null)) || ((current > cljs.core.nth.call(null,ids,(0)))))));
}));
mranderson048.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","newer-epochs-available?","epochs/newer-epochs-available?",-1411103953),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__20307){
var vec__20308 = p__20307;
var current = cljs.core.nth.call(null,vec__20308,(0),null);
var ids = cljs.core.nth.call(null,vec__20308,(1),null);
...
return cljs.core.filter.call(null,(function (p1__20311_SHARP_){
return ((day8.re_frame_10x.metamorphic.request_animation_frame_QMARK_.call(null,p1__20311_SHARP_)) || (day8.re_frame_10x.metamorphic.request_animation_frame_end_QMARK_.call(null,p1__20311_SHARP_)));
}),traces);
}));
...
args_arr__4751__auto__.push((arguments[i__4731__auto___20319]));
...
var map__20332 = cljs.core.get.call(null,match,new cljs.core.Keyword(null,"timing","timing",-1849225195));
...
var event_time = cljs.core.get.call(null,map__20332__$1,new cljs.core.Keyword("re-frame","event-time","re-frame/event-time",-1349372188));
var event_handler_time = cljs.core.get.call(null,map__20332__$1,new cljs.core.Keyword("re-frame","event-handler-time","re-frame/event-handler-time",1278050644));
var event_dofx_time = cljs.core.get.call(null,map__20332__$1,new cljs.core.Keyword("re-frame","event-dofx-time","re-frame/event-dofx-time",650880716));
var event_run_time = cljs.core.get.call(null,map__20332__$1,new cljs.core.Keyword("re-frame","event-run-time","re-frame/event-run-time",1941554897));
...
return (!(cljs.core.empty_QMARK_.call(null,p1__20334_SHARP_)));
})], null),null);
...
cljs.spec.alpha.def_impl.call(null,new cljs.core.Keyword("subs","view-subs","subs/view-subs",253084832),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","coll-of","cljs.spec.alpha/coll-of",1019430407,null),new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057)),cljs.spec.alpha.every_impl.call(null,new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057),new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("cljs.spec.alpha","kind-form","cljs.spec.alpha/kind-form",-1047104697),null,new cljs.core.Keyword("cljs.spec.alpha","cpred","cljs.spec.alpha/cpred",-693471218),(function (G__20337){
return cljs.core.coll_QMARK_.call(null,G__20337);
...
var G__20340 = (exp - (1));
var G__20341 = (total + (day8.re_frame_10x.subs.sub_type_value.call(null,sub_type) * Math.pow((10),exp)));
var G__20342 = cljs.core.rest.call(null,order__$1);
exp = G__20340;
total = G__20341;
order__$1 = G__20342;
continue;
...
var G__20343 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(t);
 ...
 */
day8.re_frame_10x.subs.prepare_pod_info = (function day8$re_frame_10x$subs$prepare_pod_info(p__20345,p__20346){
var vec__20347 = p__20345;
var sub_info = cljs.core.nth.call(null,vec__20347,(0),null);
var sub_state = cljs.core.nth.call(null,vec__20347,(1),null);
var vec__20350 = p__20346;
var subscription = cljs.core.nth.call(null,vec__20350,(0),null);
var remove_fn = ((cljs.core._EQ_.call(null,subscription,new cljs.core.Keyword("subs","intra-epoch-subs","subs/intra-epoch-subs",-1298574944)))?((function (vec__20347,sub_info,sub_state,vec__20350,subscription){
return (function (me){
return (new cljs.core.Keyword(null,"order","order",-1254677256).cljs$core$IFn$_invoke$arity$1(cljs.core.val.call(null,me)) == null);
});})(vec__20347,sub_info,sub_state,vec__20350,subscription))
:cljs.core.constantly.call(null,false));
var subx = cljs.core.sort_by.call(null,new cljs.core.Keyword(null,"order","order",-1254677256),day8.re_frame_10x.subs.sub_sort_val,cljs.core.map.call(null,((function (remove_fn,vec__20347,sub_info,sub_state,vec__20350,subscription){
return (function (me){
...
return sub__$2;
});})(remove_fn,vec__20347,sub_info,sub_state,vec__20350,subscription))
...
mranderson048.re_frame.v0v10v2.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("subs","visible-subs","subs/visible-subs",-1536647862),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","all-subs","subs/all-subs",1599770325)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","ignore-unchanged-l2-subs?","subs/ignore-unchanged-l2-subs?",-1438622704)], null),(function (p__20353){
var vec__20354 = p__20353;
var all_subs = cljs.core.nth.call(null,vec__20354,(0),null);
var ignore_unchanged_l2_QMARK_ = cljs.core.nth.call(null,vec__20354,(1),null);
...
var window_width = cljs.core.nth.call(null,vec__20358,(0),null);
var char_width = cljs.core.nth.call(null,vec__20358,(1),null);
