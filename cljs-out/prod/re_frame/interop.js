...
return [(function (){var pred__12354 = cljs.core.instance_QMARK_;
var expr__12355 = reactive_val;
if(cljs.core.truth_(pred__12354.call(null,reagent.ratom.RAtom,expr__12355))){
return "ra";
} else {
if(cljs.core.truth_(pred__12354.call(null,reagent.ratom.RCursor,expr__12355))){
return "rc";
} else {
if(cljs.core.truth_(pred__12354.call(null,reagent.ratom.Reaction,expr__12355))){
return "rx";
} else {
if(cljs.core.truth_(pred__12354.call(null,reagent.ratom.Track,expr__12355))){
return "tr";
} else {
return "other";
}
