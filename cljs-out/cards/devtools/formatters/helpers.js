...
var G__35770 = devtools.prefs.pref.call(null,v);
v = G__35770;
continue;
} else {
return v;
...
}catch (e35773){var _e__34659__auto__ = e35773;
return false;
}})();
...
}catch (e35777){var _e__34659__auto__ = e35777;
return false;
}})();
...
}catch (e35779){var _e__34659__auto__ = e35779;
return false;
}}
}
});
...
var vec__35781 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__35781,(0),null);
var name = cljs.core.nth.call(null,vec__35781,(1),null);
...
return cljs.core.some.call(null,(function (p1__35784_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__35784_SHARP_);
}),template);
});
