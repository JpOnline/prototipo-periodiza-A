...
var G__26453 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__26453,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__26453;
}
});
...
var G__26460 = (i__4731__auto___26459 + (1));
i__4731__auto___26459 = G__26460;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq26455){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26456,G__26457,seq26455__$2);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__26462,map__26462__$1,file,line,column){
return (function (p1__26461_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__26461_SHARP_));
});})(map__26462,map__26462__$1,file,line,column))
...
var temp__5735__auto___26464 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___26464)){
var message_26465 = temp__5735__auto___26464;
cljs.core.println.call(null,message_26465);
} else {
}
...
var temp__5735__auto___26466 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___26466)){
var message_26467 = temp__5735__auto___26466;
cljs.core.println.call(null,message_26467);
} else {
}
...
var output_dir__$1 = (function (){var G__26468 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__26468,"/"].join('');
} else {
return G__26468;
}
})();
...
var G__26470 = exception.stack;
var G__26470__$1 = (((G__26470 == null))?null:clojure.string.split_lines.call(null,G__26470));
var G__26470__$2 = (((G__26470__$1 == null))?null:cljs.core.get.call(null,G__26470__$1,depth));
if((G__26470__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__26470__$2);
}
} else {
...
var vec__26471 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__26471,(0),null);
var column = cljs.core.nth.call(null,vec__26471,(1),null);
var vec__26474 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__26474,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__26474,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__26474,(2),null);
...
var m__$1 = (function (){var G__26477 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__26481 = (function (){var G__26480 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__26480);
} else {
return G__26480;
}
})();
...
return cljs.core.vary_meta.call(null,G__26482,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__26486 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__26486,(0),null);
var types = vec__26486;
...
return cljs.core.map.call(null,(function (p__26489){
var vec__26490 = p__26489;
var ns = cljs.core.nth.call(null,vec__26490,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__26490,(1),null);
return ((function (vec__26490,ns,vars__$1){
return (function (){
...
var G__26493 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__26493,G__26493__$1,env,once_fixtures,each_fixtures,vec__26490,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__26493,G__26493__$1,env,once_fixtures,each_fixtures,vec__26490,ns,vars__$1){
return (function (){
var seq__26494 = cljs.core.seq.call(null,vars__$1);
var chunk__26495 = null;
var count__26496 = (0);
var i__26497 = (0);
while(true){
if((i__26497 < count__26496)){
var v = cljs.core._nth.call(null,chunk__26495,i__26497);
var temp__5735__auto___26499 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___26499)){
var t_26500 = temp__5735__auto___26499;
each_fixture_fn.call(null,((function (seq__26494,chunk__26495,count__26496,i__26497,t_26500,temp__5735__auto___26499,v,each_fixture_fn,G__26493,G__26493__$1,env,once_fixtures,each_fixtures,vec__26490,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26500)));
});})(seq__26494,chunk__26495,count__26496,i__26497,t_26500,temp__5735__auto___26499,v,each_fixture_fn,G__26493,G__26493__$1,env,once_fixtures,each_fixtures,vec__26490,ns,vars__$1))
);
} else {
}
...
var temp__5735__auto__ = cljs.core.seq.call(null,seq__26494);
if(temp__5735__auto__){
var seq__26494__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__26494__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__26494__$1);
var G__26505 = cljs.core.chunk_rest.call(null,seq__26494__$1);
var G__26506 = c__4550__auto__;
var G__26507 = cljs.core.count.call(null,c__4550__auto__);
var G__26508 = (0);
seq__26494 = G__26505;
...
var v = cljs.core.first.call(null,seq__26494__$1);
var temp__5735__auto___26509__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___26509__$1)){
var t_26510 = temp__5735__auto___26509__$1;
each_fixture_fn.call(null,((function (seq__26494,chunk__26495,count__26496,i__26497,t_26510,temp__5735__auto___26509__$1,v,seq__26494__$1,temp__5735__auto__,each_fixture_fn,G__26493,G__26493__$1,env,once_fixtures,each_fixtures,vec__26490,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26510)));
});})(seq__26494,chunk__26495,count__26496,i__26497,t_26510,temp__5735__auto___26509__$1,v,seq__26494__$1,temp__5735__auto__,each_fixture_fn,G__26493,G__26493__$1,env,once_fixtures,each_fixtures,vec__26490,ns,vars__$1))
);
} else {
}


var G__26511 = cljs.core.next.call(null,seq__26494__$1);
var G__26512 = null;
var G__26513 = (0);
var G__26514 = (0);
seq__26494 = G__26511;
chunk__26495 = G__26512;
count__26496 = G__26513;
i__26497 = G__26514;
continue;
}
} else {
...
});})(each_fixture_fn,G__26493,G__26493__$1,env,once_fixtures,each_fixtures,vec__26490,ns,vars__$1))
);
});})(each_fixture_fn,G__26493,G__26493__$1,env,once_fixtures,each_fixtures,vec__26490,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26493__$1)].join('')));

}
})());
});
;})(vec__26490,ns,vars__$1))
