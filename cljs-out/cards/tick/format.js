...
return tick.format.formatter.call(null,fmt,(function (){try{var G__10903 = goog.object.get(JSJodaLocale,"Locale");
if((G__10903 == null)){
return null;
} else {
return goog.object.get(G__10903,"US");
}
}catch (e10902){if((e10902 instanceof Error)){
var e = e10902;
return null;
} else {
throw e10902;
